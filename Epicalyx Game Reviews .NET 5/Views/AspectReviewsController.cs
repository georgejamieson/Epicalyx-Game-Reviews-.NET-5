...
namespace Epicalyx_Game_Reviews_.NET_5.Views
{
    public class AspectReviewsController : Controller
    {
        private readonly Epicalyx_Game_Reviews_NET_5ContextDb _context;

        public AspectReviewsController(Epicalyx_Game_Reviews_NET_5ContextDb context)
        {
            _context = context;
        }
